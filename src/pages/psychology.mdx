...
-	Describe questions
	...
	-	Describing a study
		...
		-	Not meeting all question client:visible criteria halves your maximum marks
...
-	Explain questions
	-	Write a description, then extend it with an explanation
		-	Give background information to show you understand the question client:visible and answer
		-	If the question client:visible is split up into 2 parts, describe and explain, write description first then write explanation in the second part, avoid repeating the same point in both parts
...
-	Situational factors that affect conformity
	...
	-	Task Difficulty
		-	Asch changed the question client:visible cards, so that the 3 comparison lines were much closer in length, increasing the task's difficulty and making answers less obvious
